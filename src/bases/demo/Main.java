...
public class Main {
	...
	public static void main(String[] args) {
		...
		Fighter figher = new Fighter("金太郎", "斧");
		...
		while (true) {
			...
			// 人間グループから1人選択
			Human man1 = choiceHuman(humans);

			// モンスターグループから1人選択
			Monster mon1 = choiceMonster(monsters);
			...
			// 人間グループから1人選択
			Human man2 = choiceHuman(humans);

			// モンスターグループから1人選択
			Monster mon2 = choiceMonster(monsters);
